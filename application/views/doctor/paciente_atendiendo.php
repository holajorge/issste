...
<nav class="navbar navbar-inverse container-fluid">
    <ul class="nav navbar-nav">
      <li><a href="<?php echo base_url();?>doctor"  style="display: none">DERECHOHABIENTE EN ESPERA</a></li>
      <li class="active"><a href="<?php echo base_url();?>atender">DERECHOHABIENTE EN CONSULTORIO</a></li>
    </ul>
...
<div class="container-fluid">
 ...
 <form  method="POST" id="form_agregaDD">
    ...
    <input type="hidden" name="id_doctor" id="id_doctor" value="<?php echo  $data['id_doctor'] ?>">
   ...
   <h1 class="text-center" style="font-family: Arial; color: black;">DATOS DEL DERECHOHABIENTE Y AGREGE UNA DESCRIPCIÓN </h1>
   <div class="contentform">
    <div class="leftcontact">
      ...
      <div  class="form-group">
        <strong>TIPO PACIENTE </strong>  
          <input disabled type="text" id="tipo_paciente<?php echo $data['id_consulta_paciente'] ?>" value="<?php echo $data['tipo_paciente']?>"/>
          <div class="validation"></div>
      </div> 
      ...
      <div  class="form-group">
        ...
        <?php if($data['clasificacion']==1){
          ...
          ?>
          <input style="background-color: #ffcc00;font-weight: bold; font-family: bold;text-align: center;border-radius: 13px;" disabled type="text" id="clasificacion<?php echo $data['id_consulta_paciente'] ?>" value="AMARILLO" />
          <div class="validation"></div>
          <?php
        } elseif ($data['clasificacion']==3) {
          ?>  
          <input style="background-color: #ff3333;color: white; font-weight: bold; font-family: bold;text-align: center; border-radius: 13px;" disabled type="text" id="clasificacion<?php echo $data['id_consulta_paciente'] ?>" value="ROJO" />
          <div class="validation"></div>
          <?php
        }?>    
    ...
    <button type="button" style="background-color: #3377ff" class="col-xs-12 col-ms-4 btn btn-primary btn-lg" onclick="volverallamarD()">VOLVER A LLAMAR PACIENTE</button><br><br>&nbsp;
      <div class="form-group col-sm-12">
       ...
       <button type="button"  onclick="insert_doctor()"  name="submit" value="save" class="col-xs-12 col-ms-4 bouton-contact  ">ATENDIDO</button>
      <!--    -->
     <button type="button" onclick="noPresentoPaciente()"  name="submit" value="save" class=" col-xs-12 col-ms-4 bouton-contact2">ELIMINAR </button>

      <p><br></p><br>&nbsp;
      <button type="button" onclick="confirmPantalla_doctor()"  style="background-color: #86592d; " class="col-xs-12 col-ms-4 btn btn-primary btn-lg">MANDAR A PANTALLA</button>
    </div>
  </div>
</form> 
</div>