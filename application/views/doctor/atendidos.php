<nav class="navbar navbar-inverse container-fluid">
    <ul class="nav navbar-nav">
      <li><a href="<?php echo base_url();?>doctor">DERECHOHABIENTE EN ESPERA</a></li>
      <li class="active"><a href="<?php echo base_url();?>doctor/atendidos" style="">DERECHOHABIENTES ATENDIDOS</a></li>
  ...
  function getRandValue()
    {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo base_url();?>doctor/atendidos_ajax",
