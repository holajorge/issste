...
<head>
  <title>URGENCIOLOGO | TRIAGE</title>
  <meta charset="UTF-8">
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>plantillas/css/doctor/paciente_atendiendo.css"/>
  ...
  <div class="cabeza">
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-6">
        <h1 class="text-center">URGENCIÓLOGO TRIAGE</h1>
      </div>
