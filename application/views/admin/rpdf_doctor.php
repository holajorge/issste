...
class RPDF_DOCTOR extends FPDF
{
    // Cabecera de página
 function Header()
 {
  ...
  $this->Cell(5,5,'LISTA DE PACIENTES POR DOCTOR',3,3,'L');
...
$this->myfpdf = new RPDF_DOCTOR('L');

        //[string orientacion[,mixed formato]]
$this->myfpdf->AddPage('L');
$this->myfpdf->AliasNbPages();

$this->myfpdf->SetTitle('LISTA DE PACIENTES POR DOCTOR');
...
$this->myfpdf->Output("Lista de pacientes por doctor.pdf", 'I');
