...
<nav class="navbar navbar-inverse container-fluid">
   ...
   <li class="active"><a href="<?php echo base_url();?>admin/espera">EN ESPERA</a></li>
  ...
  <div role="tappanel">
    <div class="row">
      <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active"><a href="#seccion1" aria-controls="" data-toggle="tab" role="tab">DERECHOABIENTES EN ESPERA</a></li>
      </ul><br>
    </div>
      ...
      <div role="tabpanel" class="tab-pane active" id="seccion1">
        <div class="row">
          <div class="panel panel-primary">
            <div class="panel-heading text-center" style="font-family: Arial;">LISTA DE DERECHOABIENTES EN ESPERA</div>
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    setInterval(function(){
      $('#show').load('<?php echo base_url();?>admin/ajax_Enfermero')
    },500);
