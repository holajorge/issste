...
<nav class="navbar navbar-inverse container-fluid">
    ...
    <ul class="nav navbar-nav">             
     ...
     <li  class="active" ><a href="<?php echo base_url();?>enfermero/no_asistio">FALTANTES</a></li>
   </ul>
  ...
  <div role="tappanel">
    <div class="row">
      <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active"><a href="#seccion1" aria-controls="" data-toggle="tab" role="tab">DERECHOHABIENTES QUE NO ASISTIERON </a></li>
      </ul><br>
    </div>
      ...
      <div role="tabpanel" class="tab-pane active" id="seccion1">
        ...
        <div class="row">
          <div class="panel panel-primary">
            <div class="panel-heading text-center" style="font-family: Arial">LISTA DERECHOHABIENTES QUE NO ASISTIERON A SU CONSULTA</div>
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    setInterval(function(){
      $('#show').load('<?php echo base_url();?>enfermero/ajax_no_asistio')
    },500);
