<nav class="navbar navbar-inverse container-fluid">
  ...
  <ul class="nav navbar-nav">
    ...
    <li class="active"><a href="<?php echo base_url();?>enfermero/consultorio"> EN CONSULTA</a></li>
...
<div class="container-fluid">
    ...
    <div class="row">
      <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active"><a href="#seccion1" aria-controls="" data-toggle="tab" role="tab">DERECHOHABIENTE EN CONSULTA</a></li>
      </ul>
    </div><br>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        setInterval(function(){
            $('#show').load('<?php echo base_url();?>enfermero/consultorio_ajax')
        },500);
